...
public class CudamiRepositoryManager {
  ...
  public DigitalObject getDigitalObject(DigitalObject digitalObjectExample) {
    Watch digitalObjectWatch = this.metrics.startMeasure(ProcessingMetrics.MetadataOperation.GET_DIGITALOBJECT);
    Watch itemWatch = this.metrics.startMeasure(ProcessingMetrics.MetadataOperation.GET_ITEM);
    Watch manifestationWatch = this.metrics.startMeasure(ProcessingMetrics.MetadataOperation.GET_MANIFESTATION);
    Watch workWatch = this.metrics.startMeasure(ProcessingMetrics.MetadataOperation.GET_WORK);

    Watch fullDigitalObjectWatch = this.metrics.startMeasure(ProcessingMetrics.MetadataOperation.GET_FULL_DIGITALOBJECT);
