...
@Service
public class ModsItemsServiceImpl implements ModsItemsService {

  private static final Logger LOGGER = LoggerFactory.getLogger(ModsItemsServiceImpl.class);
  ...
  public OriginInfo createOriginInfo(DigitalObject digitalObject) {
    OriginInfo.Builder originInfoBuilder = OriginInfo.builderForOriginInfo();
  ...
  private ShelfLocator createShelfLocator(DigitalObject digitalObject) {
