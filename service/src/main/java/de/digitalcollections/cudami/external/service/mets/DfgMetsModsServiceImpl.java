...
public class DfgMetsModsServiceImpl implements DfgMetsModsService {
  ...
  public Mets getMetsForDigitalObject(DigitalObject digitalObjectExample) throws ServiceException {
    ...
    try {
      ...
      throw new ServiceException("Cannot process mdsec: " + e, e);
    }
    ...
    try {
      ...
      throw new ServiceException("Cannot process rightsMD: " + e, e);
    }
    ...
    try {
      ...
      throw new ServiceException("Cannot process digiprovMD: " + e, e);
    }
